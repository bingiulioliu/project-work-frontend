...
| `ProductCard.jsx` | Card prodotto riutilizzabile (usata in homepage, emporio, suggeriti) con azioni rapide (wishlist/carrello) |
...
| `ProductsList.jsx` | Emporio completo: filtri, ordinamento, paginazione, sincronizzazione con l'URL |
