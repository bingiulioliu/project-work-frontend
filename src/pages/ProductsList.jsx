    ...
    function handleRarityToggle(rarityValue) {
        setSelectedRarities((current) => {
            if (current.includes(rarityValue)) {
                return current.filter((rarity) => rarity !== rarityValue);
            }
                ...
                <div className="row g-3 align-items-end">
                    <div className="col-12 col-lg-4">
                        ...
                        <input
                            ...
                            placeholder="Es. Grimorio, pozione, amuleto..."
                            value={searchTerm}
                    ...
                    <div className="col-12">
                        <div className="filter-bottom-row">
                            <div className="rarity-area">
                                <span className="filter-label rarity-label">
                                    Rarità
                                </span>
                                ...
                                <div className="rarity-toggle-group">
                                    {ALL_RARITIES.map((rarityValue) => (
                                        <button
                                            key={rarityValue}
                                            type="button"
                                            className={`rarity-toggle rarity-toggle-${rarityValue} ${
                                            ...
                                            onClick={() =>
                                                handleRarityToggle(rarityValue)
                                            }
                                        >
                                            {rarityValue === "common" &&
                                                "Comune"}
                    ...
                    <div className="col-12">
                        <div className="text-center py-5 border rounded-3 bg-dark bg-opacity-25">
                            ...
                            <h2 className="h5 text-secondary">
                                Il tuo incantesimo di ricerca non ha evocato
                                nulla.
                            </h2>
            ...
            {pagination && pagination.totalPages > 1 && !isLoading && (
                <div className="products-pagination">
                    ...
                    <span className="products-page-info">
                        Pagina {pagination.currentPage} di{" "}
